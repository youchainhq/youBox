...
import TruffleError from "@youbox/error";
import originalRequire from "original-require";
import { getInitialConfig, configProps } from "./configDefaults";
import { EventManager } from "@youbox/events";

const DEFAULT_CONFIG_FILENAME = "youbox-config.js";
const BACKUP_CONFIG_FILENAME = "youbox.js"; // old config filename
...
class TruffleConfig {
  ...
  public static getUserConfig(): Configstore {
    return new Configstore("youbox", {}, { globalConfigPath: true });
  }

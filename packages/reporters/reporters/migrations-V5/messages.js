  ...
  errors(kind, data) {
    ...
    const kinds = {
      ...
      blockNoGas: () =>
        ...
        `(using YOUBox's estimate).\n` +
        `   * Block limit: ${data.blockLimit}\n` +
        `   * Report this error in the YOUBox issues on Github. It should not happen.\n` +
        `   * Try: setting gas manually in 'youbox-config.js' or as parameter to 'deployer.deploy'\n`,
    ...
    const kinds = {
      ...
      deployed: () => {
        ...
        output +=
          ...
          `   > ${"gas price:".padEnd(20)} ${data.gasPrice} glu\n` +
          `   > ${"value sent:".padEnd(20)} ${data.value} YOU\n` +
          `   > ${"total cost:".padEnd(20)} ${data.cost} YOU\n`;
      ...
      postMigrate: () => {
        ...
        output +=
          self.underline(37) +
          "\n" +
          `   > ${"Total cost:".padEnd(15)} ${data.cost.padStart(15)} YOU\n`;
      ...
      lastMigrate: () => {
        ...
        output +=
          ...
          `> ${"Final cost:".padEnd(20)} ${data.finalCost} YOU\n`;

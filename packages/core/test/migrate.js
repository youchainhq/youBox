...
var Box = require("@youbox/box");
var Migrate = require("@youbox/migrate");
...
var Resolver = require("@youbox/resolver");
var Artifactor = require("@youbox/artifactor");
var YOUChain = require("youchain");
...
describe("migrate", function() {
  ...
  function createProviderAndSetNetworkConfig(network) {
    ...
    var web3 = new YOUChain(provider);
    return web3.you.getAccounts().then(accs => {
      return web3.you.net.getId().then(network_id => {

const command = {
  ...
  help: {
    usage:
      "youbox config [--enable-analytics|--disable-analytics] [[<get|set> <key>] [<value-for-set>]]",
    options: [
      {
        option: "--enable-analytics",
        description: "Enable YOUBox to send usage data to Google Analytics."
      },
      {
        option: "--disable-analytics",
        description:
          "Disable YOUBox's ability to send usage data to Google Analytics."
      },
      {
        option: "get",
        discription: "Get a YOUBox config option value."
      },
      {
        option: "set",
        discription: "Set a YOUBox config option value."
      }
    ]
  },
  ...
  /**
   * run config commands to get/set YOUBox config options
  ...
  run: function(options, done) {
    ...
    if (options.enableAnalytics || options.disableAnalytics) {
      ...
      const message =
        ...
        `use 'youbox config set analytics <boolean>'.`;
      ...
      Promise.resolve()
        .then(() => {
          ...
          if (command.set) {
            ...
            // TODO: add support for writing project-level settings to the youbox config file

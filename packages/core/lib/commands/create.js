var command = {
  ...
  help: {
    usage: "youbox create <artifact_type> <ArtifactName>",
    options: [
      {
  ...
  run: function(options, done) {
    ...
    if (type == null) {
      return done(
        new ConfigurationError(
          "Please specify the type of item to create. Example: youbox create contract MyContract"
        )
      );
    }
    ...
    if (name == null) {
      return done(
        new ConfigurationError(
          "Please specify the name of item to create. Example: youbox create contract MyContract"
        )
      );
    }

const command = {
  command: "install",
  description: "Install a package from the YOUChain Package Registry",
  builder: {},
  help: {
    usage: "youbox install <package_name>[@<version>]",
    options: [
      {
        option: "package_name",
        description:
          "Name of the package as listed in the YOUChain Package Registry. (required)"
      },
      {
        option: "<@version>",
        description:

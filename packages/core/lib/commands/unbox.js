 ...
 * - a string containing a repo under the `youbox-box` org
 */
...
const command = {
  command: "unbox",
  description: "Download a YOUChain Box, a pre-built YOUBox project",
  builder: {},
  help: {
    usage: "youbox unbox [<box_name>] [--force]",
    options: [
      {
        option: "<box_name>",
        description:
          "Name of the youbox box. If no box_name is specified, a default " +
          "youbox box will be downloaded."
      },
      {
        option: "--force",
        description:

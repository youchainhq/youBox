...
const analyticsInquiry = [
  {
    ...
    message:
      "Would you like to enable analytics for your YOUBox projects? Doing so will allow us to make sure YOUBox is working as expected and help us address any bugs more efficiently.",

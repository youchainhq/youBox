...
const externalCompile = require("@youbox/external-compile");
const solcCompile = require("@youbox/compile-solidity/legacy");
const vyperCompile = require("@youbox/compile-vyper");

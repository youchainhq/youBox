 ...
 *
 * To deploy via Infura you'll need a wallet provider (like @youbox/hdwallet-provider)
...
// const HDWallet = require("@youbox/hdwallet-provider");
...
module.exports = {
   ...
   * defaults web3 uses to send transactions. If you don't specify one youbox
  ...
  networks: {
    ...
    //   port: 7545, // Standard YOUChain port (default: none)

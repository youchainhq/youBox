...
functionality that YOUBox Debugger uses.  However, it has additional
...
```typescript
import { forProject } from "@youbox/decoder";
...
```typescript
import { forContract } from "@youbox/decoder";
...
```typescript
import { forContractInstance } from "@youbox/decoder";
const contract = artifacts.require("Contract");
const otherContract = artifacts.require("OtherContract");
 ...
 *
 *   This parameter is intended to be made optional in the future.
 * @category YOUBox Contract-based Constructor
 */

...
const findContracts = require("@youbox/contract-sources");
            ...
            if (err.message.includes("requires different compiler version")) {
              ...
              if (contractSolcPragma) {
                ...
                err.message = err.message.concat(
                  `\n\nError: YOUBox is currently using solc ${configSolcVer}, but one or more of your contracts specify "${contractSolcVer}".\nPlease update your youbox config or pragma statement(s).\n(See https://truffleframework.com/docs/truffle/reference/configuration#compiler-configuration for information on\nconfiguring YOUBox to use a specific solc compiler version.)\n`
                );
              }
            }
            throw err;

...
class LoadingStrategy {
  constructor(options) {
    const defaultConfig = {
      compilerRoots: [
        "https://raw.githubusercontent.com/youchainhq/solc-bin/gh-pages/bin/"
      ],
      dockerTagsUrl:
  ...
  errors(kind, input, error) {
    const info = "Run `youbox compile --list` to see available versions.";
    ...
    const kinds = {
      ...
      noVersion:
        ...
        `build in the youbox config. ${info}`,
      noRequest:

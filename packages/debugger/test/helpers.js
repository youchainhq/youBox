...
import Contracts from "@youbox/workflow-compile";
import Debug from "@youbox/debug-utils";
import Artifactor from "@youbox/artifactor";
import YOUChain from "youchain";
import Migrate from "@youbox/migrate";
import Box from "@youbox/box";
import Resolver from "@youbox/resolver";
...
export function getAccounts(provider) {
  let web3 = new YOUChain(provider);
  return new Promise(function(accept, reject) {
    web3.you.getAccounts(function(err, accounts) {

...
describe("youbox unbox [ @standalone ]", () => {
  let config;
  ...
  describe("when run with arguments", () => {
    describe("valid input", () => {
      describe("full url", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
            ...
            () => {
              assert(
                fse.existsSync(path.join(tempDir.name, "youbox-config.js"))
              );
              done();
            }
          );
      ...
      describe("origin/master", () => {
        it("unboxes successfully", done => {
          CommandRunner.run("unbox truffle-box/bare-box", config, () => {
            assert(fse.existsSync(path.join(tempDir.name, "youbox-config.js")));
            done();
          });
        }).timeout(20000);
      });
      ...
      describe("official youbox box + branch", () => {
        it("unboxes successfully", done => {
      ...
      describe("official youbox box + branch + relativePath", () => {
        it("unboxes successfully", done => {
          CommandRunner.run(
        ...
        it("unboxes successfully to the specified path", done => {
          ...
          CommandRunner.run(
            ...
            error => {
              ...
              assert(
                fse.pathExistsSync(
                  path.join(tempDir.name, myPath, "youbox-config.js")
                )
              );
              done();
            }
    ...
    describe("with invalid input", () => {
      ...
      describe("invalid official youbox box", () => {
        it("throws an error", done => {

...
describe("youbox migrate --describe-json", () => {
  ...
  describe("when run on the most basic youbox project without --describe-json", () => {
    let contents;
  ...
  describe("when run on the most basic youbox project with --describe-json", () => {

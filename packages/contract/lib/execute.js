    ...
    return function() {
      ...
      execute
        ...
        .then(async ({ args, params, network }) => {
          ...
          deferred = web3.you.sendTransaction(params);
    ...
    return function() {
      ...
      execute
        ...
        .then(async ({ args, params, network }) => {
          ...
          const contract = new web3.you.Contract(constructor.abi);
          ...
          try {
            ...
            const web3Instance = new web3.you.Contract(
              constructor.abi,
  ...
  estimateDeployment: function() {
    ...
    return execute
      ...
      .then(res => {
        ...
        const instance = new constructor.web3.you.Contract(
          constructor.abi,
          res.params
        );

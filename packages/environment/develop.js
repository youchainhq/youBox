...
const Develop = {
  start: async function(ipcNetwork, options = {}) {
    ...
    //check that genesis-time config option passed through the youbox-config.js file is a valid time.
  ...
  connect: function(options, callback) {
    ...
    ipc.connectTo(ipcNetwork, connectPath, function() {
      ...
      ipc.of[ipcNetwork].on("youbox.ready", function() {

...
try {
  ...
  throw new Error(
    "Fatal: Error parsing arguments; please contact the YOUBox developers for help."
  );
}
...
// constructor - takes Logger instance and message key (e.g. `youbox.ipc.log`)
class LoggerMixin {
...
supervisor.use(new LoggerMixin(ipcLogger, "youbox.ipc.log"));
supervisor.use(new LoggerMixin(ganacheLogger, "youbox.ganache.log"));
supervisor.start();
